...
{
    public class ServiceAdsPerson(MeisterContext _context) : IServiceAdsPerson
    {



        //*****************************************************************
        IEnumerable<DTO_AdsPerson> IServiceAdsPerson.Read()
        {
            IEnumerable<DTO_AdsPerson> result = from worker in _context.Workers
