...
namespace GCommon.Models
{
    ...
    /// </summary>
    public class AdvertisementToWorkerViewModel
    {
        ...
        public required IEnumerable<WorkHourViewModel>? HourList { get; set; }
        //**************************************************************************
        
        public required IEnumerable<SelectWorkCapabilityViewModel>? CapalityList { get; set; }
        //**************************************************************************
        public required string WorkerFullName { get; set; }
        //**************************************************************************
        public static AdvertisementToWorkerViewModel Empty(int id,string worker_name)
        {
            AdvertisementToWorkerViewModel Empty = new AdvertisementToWorkerViewModel()
            {
                ID = null,
                WorkerID = id,
